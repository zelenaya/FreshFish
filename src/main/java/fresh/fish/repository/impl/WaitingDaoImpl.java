...
import fresh.fish.repository.WaitingDao;
...
public class WaitingDaoImpl implements WaitingDao {
    ...
    public static final String WAITING_ID = "cust_id";
    public static final String CUST__ID = "cust_user_id";
    public static final String PROD_ID = "name";
    public static final String COUNT = "surmane";

    public static final String DATE_CREATED = "date_created";
    public static final String DATE_CLOSE = "date_modificated";
